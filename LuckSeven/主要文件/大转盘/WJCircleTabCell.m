...
+ (instancetype)sharedCell:(UITableView *)tableView {
    NSString *ID = NSStringFromClass([WJCircleTabCell class]);
    WJCircleTabCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[WJCircleTabCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
    }
